...
public class BankController {
    ...
    public ResponseEntity<String> printTokenInfo(@AuthenticationPrincipal Jwt jwt){
        ...
        System.out.println("NEXT PROPS ARE FROM AUTHENTICATION OBJECT");
        System.out.println("Details: " + authentication.getDetails());
        System.out.println("Name: " + authentication.getName());
        System.out.println("Credentials: " + authentication.getCredentials().toString());
        System.out.println("Principal subject: " + ((Jwt)authentication.getPrincipal()).getSubject());
        System.out.println("Principal claims: " + ((Jwt)authentication.getPrincipal()).getClaims().toString());
        System.out.println("Athentication object Authorities: ");
